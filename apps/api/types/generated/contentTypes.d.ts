...
export interface ApiAboutMeAboutMe extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::about-me.about-me'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
  };
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    introductionImage: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    finishedDate: Schema.Attribute.Date &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiTagTag extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    experiences: Schema.Attribute.Relation<'manyToMany', 'api::experience.experience'>;
    locale: Schema.Attribute.String;
    ...
    type: Schema.Attribute.Enumeration<
      ['Programming Language', 'Frontend', 'Backend', 'DevOps', 'Database', 'Others', 'Non Dev']
    > &
      Schema.Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
