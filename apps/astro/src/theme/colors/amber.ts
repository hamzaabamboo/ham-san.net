...
export const amber = defineSemanticTokens.colors({
  ...
  '9': { value: { _light: '#ffb000', _dark: '#ffb000' } },
  '10': { value: { _light: '#ffba18', _dark: '#ffbe33' } },
  ...
  a9: { value: { _light: '#ffb300c2', _dark: '#ffb000' } },
  a10: { value: { _light: '#ffb300e7', _dark: '#ffbe33' } },
  a11: { value: { _light: '#ab6400', _dark: '#ffca16' } },
  a12: { value: { _light: '#341a00ee', _dark: '#ffeebf' } },
