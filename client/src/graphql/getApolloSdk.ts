import type { QueryOptions, MutationOptions, ApolloClient } from '@apollo/client';
import type { DocumentNode } from 'graphql';
import { type Requester, getSdk } from './generated/server';
...
export function getApolloSdk<C>(client: ApolloClient<C>) {
...
export type Sdk = ReturnType<typeof getApolloSdk>;
