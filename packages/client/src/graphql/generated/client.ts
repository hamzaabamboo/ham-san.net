...
export const ProjectPreviewFragmentDoc = gql`
  ...
  tags {
    ...
    ${MediaFragmentDoc}
${TagFragmentDoc}`;
export const FetchAboutMeDoc = gql`
...
${TagFragmentDoc}`;
export const FetchBlogPostsDoc = gql`
  ...
  blogs(
    ...
    ${BlogFragmentDoc}`;
export const FetchHomePageDoc = gql`
...
${MediaFragmentDoc}`;
export const FetchProjectsDoc = gql`
  ...
  projects(
    ...
    ${ProjectPreviewFragmentDoc}`;
export const GetBlogPostBySlugDoc = gql`
  ...
  blogs(filters: {slug: {eq: $slug}}, locale: $locale) {
    ...
    ${BlogFragmentDoc}`;
export const GetProjectBySlugDoc = gql`
  ...
  projects(filters: {slug: {eq: $slug}}, locale: $locale) {
    ...
    ${ProjectFragmentDoc}`;
export const GetTagBySlugDoc = gql`
...
export const fetchAboutMe = (
            options: Omit<
              WatchQueryOptions<FetchAboutMeQueryVariables>, 
              "query"
            >
          ): Readable<
            ApolloQueryResult<FetchAboutMeQuery> & {
              query: ObservableQuery<
                FetchAboutMeQuery,
                FetchAboutMeQueryVariables
              >;
            }
          > => {
            const q = client.watchQuery({
              query: FetchAboutMeDoc,
              ...options,
            });
            var result = readable<
              ApolloQueryResult<FetchAboutMeQuery> & {
...
export const fetchBlogPosts = (
            options: Omit<
              WatchQueryOptions<FetchBlogPostsQueryVariables>, 
              "query"
            >
          ): Readable<
            ApolloQueryResult<FetchBlogPostsQuery> & {
              query: ObservableQuery<
                FetchBlogPostsQuery,
                FetchBlogPostsQueryVariables
              >;
            }
          > => {
            const q = client.watchQuery({
              query: FetchBlogPostsDoc,
              ...options,
            });
            var result = readable<
              ApolloQueryResult<FetchBlogPostsQuery> & {
...
export const fetchHomePage = (
            options: Omit<
              WatchQueryOptions<FetchHomePageQueryVariables>, 
              "query"
            >
          ): Readable<
            ApolloQueryResult<FetchHomePageQuery> & {
              query: ObservableQuery<
                FetchHomePageQuery,
...
export const fetchProjects = (
            options: Omit<
              WatchQueryOptions<FetchProjectsQueryVariables>, 
              "query"
            >
          ): Readable<
            ApolloQueryResult<FetchProjectsQuery> & {
              query: ObservableQuery<
                FetchProjectsQuery,
...
export const getBlogPostBySlug = (
            options: Omit<
              WatchQueryOptions<GetBlogPostBySlugQueryVariables>, 
              "query"
            >
          ): Readable<
            ApolloQueryResult<GetBlogPostBySlugQuery> & {
              query: ObservableQuery<
...
export const getProjectBySlug = (
            options: Omit<
              WatchQueryOptions<GetProjectBySlugQueryVariables>, 
              "query"
            >
          ): Readable<
            ApolloQueryResult<GetProjectBySlugQuery> & {
              query: ObservableQuery<
...
export const getTagBySlug = (
            options: Omit<
              WatchQueryOptions<GetTagBySlugQueryVariables>, 
              "query"
            >
          ): Readable<
            ApolloQueryResult<GetTagBySlugQuery> & {
              query: ObservableQuery<
                GetTagBySlugQuery,
